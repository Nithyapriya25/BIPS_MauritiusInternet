...
@Entity
@Table(name = "MERCHANT_CONTACT_DETAILS_MOD")
@IdClass(MerchantContactID.class)
public class Merchant_Contact_entity_Mod {
	...
	public Merchant_Contact_entity_Mod(String srl_no, String merchant_id, String mer_contact_person, String mer_email, String mer_mobile_number, 
	...
	public Merchant_Contact_entity_Mod() {
		super();
	}

	public Merchant_Contact_entity_Mod(Merchant_Contact_entity up ) {
		super();
