...
public class UserProfile implements UserDetails{
	...
	public String toString() {
		return "UserProfile [bank_code=" + bank_code + ", bank_name=" + bank_name + ", branch_code=" + branch_code
				...
				+ ", password_expiry_date=" + password_expiry_date + ", user_status=" + user_status + ", login_status="
				+ login_status + ", virtual_flg=" + virtual_flg + ", work_class=" + work_class + ", mob_number="
				+ mob_number + ", email_id=" + email_id + ", role_id=" + role_id + ", role_desc=" + role_desc
				+ ", permissions=" + permissions + ", per_effctive_date=" + per_effctive_date + ", admin=" + admin
				...
				+ disable_flg + ", photo=" + Arrays.toString(photo) + ", domain_id=" + domain_id + ", new_user_flg="
				+ new_user_flg + ", remarks=" + remarks + ", userlog_flg=" + userlog_flg + ", getUserlog_flg()="
				+ getUserlog_flg() + ", getRemarks()=" + getRemarks() + ", getBank_code()=" + getBank_code()
				+ ", getBank_name()=" + getBank_name() + ", getBranch_code()=" + getBranch_code()
				+ ", getBranch_name()=" + getBranch_name() + ", getEmpid()=" + getEmpid() + ", getEmp_name()="
				+ getEmp_name() + ", getUserid()=" + getUserid() + ", getUsername()=" + getUsername()
				+ ", getInactive_time()=" + getInactive_time() + ", getAcc_exp_date()=" + getAcc_exp_date()
				+ ", getLogin_low()=" + getLogin_low() + ", getLogin_high()=" + getLogin_high()
				+ ", getDisable_start_date()=" + getDisable_start_date() + ", getDisable_end_date()="
				+ getDisable_end_date() + ", getPassword()=" + getPassword() + ", getPassword_expiry_date()="
				+ getPassword_expiry_date() + ", getUser_status()=" + getUser_status() + ", getLogin_status()="
				+ getLogin_status() + ", getVirtual_flg()=" + getVirtual_flg() + ", getWork_class()=" + getWork_class()
				+ ", getMob_number()=" + getMob_number() + ", getEmail_id()=" + getEmail_id() + ", getRole_id()="
				+ getRole_id() + ", getRole_desc()=" + getRole_desc() + ", getPermissions()=" + getPermissions()
				+ ", getPer_effctive_date()=" + getPer_effctive_date() + ", getAdmin()=" + getAdmin()
				+ ", getXbrl_configuration()=" + getXbrl_configuration() + ", getXbrl_report()=" + getXbrl_report()
				+ ", getScheduler()=" + getScheduler() + ", getExecution()=" + getExecution() + ", getMis_reports()="
				+ getMis_reports() + ", getXml_reports()=" + getXml_reports() + ", getArchivel()=" + getArchivel()
				+ ", getGeneral_inq()=" + getGeneral_inq() + ", getAudit_inq()=" + getAudit_inq() + ", getChannel()="
				+ getChannel() + ", getEntry_user()=" + getEntry_user() + ", getEntry_time()=" + getEntry_time()
				+ ", getAuth_user()=" + getAuth_user() + ", getAuth_time()=" + getAuth_time() + ", getModify_user()="
				+ getModify_user() + ", getModify_time()=" + getModify_time() + ", getEntity_flg()=" + getEntity_flg()
				+ ", getAuth_flg()=" + getAuth_flg() + ", getModify_flg()=" + getModify_flg() + ", getDel_flg()="
				+ getDel_flg() + ", getSession_id()=" + getSession_id() + ", getLogin_flg()=" + getLogin_flg()
				+ ", getUser_locked_flg()=" + getUser_locked_flg() + ", getNo_of_attmp()=" + getNo_of_attmp()
				+ ", getDisable_flg()=" + getDisable_flg() + ", getDomain_id()=" + getDomain_id() + ", getPhoto()="
				+ Arrays.toString(getPhoto()) + ", getNew_user_flg()=" + getNew_user_flg() + ", getAuthorities()="
				+ getAuthorities() + ", isAccountNonExpired()=" + isAccountNonExpired() + ", isAccountNonLocked()="
				+ isAccountNonLocked() + ", isCredentialsNonExpired()=" + isCredentialsNonExpired() + ", isEnabled()="
				+ isEnabled() + ", ispasswordnotexpiry()=" + ispasswordnotexpiry() + ", isLoginAllowed()="
				+ isLoginAllowed() + ", isPresent()=" + isPresent() + ", get()=" + get() + ", getClass()=" + getClass()
	...
	public  UserProfile(IPSUserPreofileMod userProfile) {
