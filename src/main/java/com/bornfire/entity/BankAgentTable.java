...
public class BankAgentTable {
	...
	public String getBank_acc_leng() {
		return bank_acc_leng;
	}

	public void setBank_acc_leng(String bank_acc_leng) {
		this.bank_acc_leng = bank_acc_leng;
	}
	...
	public BankAgentTable(String bank_code, String bank_name, String bank_agent, String bank_agent_account,
			...
			String verify_user, Date verify_time,String agent_type,String business_central_bank_code,String bank_acc_leng) {
	...
	public BankAgentTable(BankAgentTmpTable tmpData) {
