...
public class IPSUserPreofileMod implements UserDetails {
	...
	public String toString() {
		return "IPSUserPreofileMod [bank_code=" + bank_code + ", bank_name=" + bank_name + ", branch_code="
				...
				+ ", getUserlog_flg()=" + getUserlog_flg() + ", getBank_code()=" + getBank_code() + ", getBank_name()="
				+ getBank_name() + ", getBranch_code()=" + getBranch_code() + ", getBranch_name()=" + getBranch_name()
				+ ", getEmpid()=" + getEmpid() + ", getEmp_name()=" + getEmp_name() + ", getUserid()=" + getUserid()
				+ ", getUsername()=" + getUsername() + ", getInactive_time()=" + getInactive_time()
				+ ", getAcc_exp_date()=" + getAcc_exp_date() + ", getLogin_low()=" + getLogin_low()
				+ ", getLogin_high()=" + getLogin_high() + ", getDisable_start_date()=" + getDisable_start_date()
				+ ", getDisable_end_date()=" + getDisable_end_date() + ", getPassword()=" + getPassword()
				+ ", getUser_status()=" + getUser_status() + ", getLogin_status()=" + getLogin_status()
				+ ", getVirtual_flg()=" + getVirtual_flg() + ", getWork_class()=" + getWork_class()
				...
				+ ", getDisable_flg()=" + getDisable_flg() + ", getPhoto()=" + Arrays.toString(getPhoto())
				+ ", getDomain_id()=" + getDomain_id() + ", getNew_user_flg()=" + getNew_user_flg() + ", getRemarks()="
				+ getRemarks() + ", getPassword_expiry_date()=" + getPassword_expiry_date() + ", getAuthorities()="
				...
				+ isEnabled() + ", isLoginAllowed()=" + isLoginAllowed() + ", getClass()=" + getClass()
				+ ", hashCode()=" + hashCode() + ", toString()=" + super.toString() + "]";
	}

	public  IPSUserPreofileMod(UserProfile userProfile) {
	...
	public IPSUserPreofileMod(String bank_code, String bank_name, String branch_code, String branch_name, String empid,
