...
public class Twofactorauth {
	...
	public String toString() {
		return "Twofactorauth [user_id=" + user_id + ", username=" + username + ", password_hash=" + password_hash
				+ ", two_fa_enabled=" + two_fa_enabled + ", preferred_method=" + preferred_method + ", phone_number="
				+ phone_number + ", email=" + email + ", auth_app_secret=" + auth_app_secret + ", security_answer_1="
				+ security_answer_1 + ", security_answer_2=" + security_answer_2 + ", security_answer_3="
				+ security_answer_3 + ", security_answer_4=" + security_answer_4 + ", security_answer_5="
				+ security_answer_5 + ", security_answer_6=" + security_answer_6 + ", security_answer_7="
				+ security_answer_7 + ", security_answer_8=" + security_answer_8 + ", security_answer_9="
				+ security_answer_9 + ", security_answer_10=" + security_answer_10 + "]";
	}
