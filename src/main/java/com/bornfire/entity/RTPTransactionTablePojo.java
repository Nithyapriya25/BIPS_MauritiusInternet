...
public class RTPTransactionTablePojo {
	...
	public RTPTransactionTablePojo(String doc_sub_id, String doc_ref_id, Date tran_date, Date value_date, String tran_ref_id,
	...
	public RTPTransactionTablePojo() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public RTPTransactionTablePojo( RTPTransactionTable rtpData) {
		super();
		this.doc_sub_id = rtpData.getDoc_sub_id();
		this.doc_ref_id = rtpData.getDoc_ref_id();
		this.tran_date = rtpData.getTran_date();
		this.value_date = rtpData.getValue_date();
		this.tran_ref_id = rtpData.getTran_ref_id();
		this.tran_type = rtpData.getTran_type();
		this.tran_ref_part_tran_id = rtpData.getTran_ref_part_tran_id();
		this.remit_account_no = rtpData.getRemit_account_no();
		this.rem_name = rtpData.getRem_name();
		this.rem_mobile_no = rtpData.getRem_mobile_no();
		this.rem_nic_no = rtpData.getRem_nic_no();
		this.ben_bank_code = rtpData.getBen_bank_code();
		this.ben_branch_code = rtpData.getBen_branch_code();
		this.ben_acct_no = rtpData.getBen_acct_no();
		this.ben_acct_name = rtpData.getBen_acct_name();
		this.ben_nick_name = rtpData.getBen_nick_name();
		this.tran_crncy_code = rtpData.getTran_crncy_code();
		this.tran_amt = rtpData.getTran_amt();
		this.chk_flg = rtpData.getChk_flg();
		this.chg_amt = rtpData.getChg_amt();
		this.def_chg_amt = rtpData.getDef_chg_amt();
		this.split_flg = rtpData.getSplit_flg();
		this.split_mast_tran_ref = rtpData.getSplit_mast_tran_ref();
		this.entry_time = rtpData.getEntry_time();
		this.verify_time = rtpData.getVerify_time();
		this.modify_time = rtpData.getModify_time();
		this.entry_user = rtpData.getEntry_user();
		this.modify_user = rtpData.getModify_user();
		this.verify_user = rtpData.getVerify_user();
		this.entity_flg = rtpData.getEntity_flg();
		this.modify_flg = rtpData.getModify_flg();
		this.del_flg = rtpData.getDel_flg();
		this.master_ref_no = rtpData.getMaster_ref_no();
		this.ips_ref_no = rtpData.getIps_ref_no();
	}
